...
public class HeroIcon extends Image {
	...
	public static final int DELAY_ACT       = 111; //veteran
	public static final int ARROW_BLAST     = 112; //ranger
	public static final int MISSILE_MARK    = 113; //bladedancer
	public static final int GAS_EXPLODE     = 114; //bomber
	public static final int HOMUNCULUS      = 115; //potionist
	public static final int FLEEING         = 116; //potionist
	public static final int VIAL_BREWING    = 117; //potionist
